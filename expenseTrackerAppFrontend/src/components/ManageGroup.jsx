...
import { deleteGroup, fetchGroups } from '../features/groupSlice';
...
const ManageGroup = () => {
    ...
    return (
        <div className="min-h-screen flex bg-gray-100">
            {/* Sidebar */}
            <aside className="w-25% bg-white shadow-md p-6 hidden md:block">
                <Header />
            </aside>
            ...
            <main className="flex-1 p-8 max-w-6xl mx-auto">
                ...
                {groupLoading ? (
                    <div className="flex justify-center py-10 text-indigo-500">
                    ...
                    <div className="text-center text-gray-500 py-10">
                        No groups found. Click "Add Group" to create your first one.
                    </div>
                ) : (
                        ...
                        {groups.map((group) => (
                            <div key={group.id} className="bg-white rounded-lg shadow p-5 border border-gray-200 relative">
                                ...
                                <button
                                    ...
                                    className="absolute top-2 right-2 bg-red-500 text-white rounded-sm text-xs hover:text-white-800 font-semibold p-1 transition duration-200"
                                >
                                    Delete
                                </button>
            ...
            {showModal && (
                <div className="fixed inset-0  backdrop-blur-xs flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded-lg w-80 shadow-lg">
                        <h2 className="text-lg font-semibold text-gray-800 mb-4">Are you sure you want to delete this group?</h2>
